...
def i(bot,update,args):
    ...
    bot.sendMessage(ADMIN_ID,msg,parse_mode=ParseMode.MARKDOWN,disable_web_page_preview=True)
    if str(update.message.from_user.username)!=ADMIN_USERNAME:
